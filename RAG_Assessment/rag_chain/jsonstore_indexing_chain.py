...
from llama_index.storage.docstore.json_file import JSONFileDocumentStore # Changed import
...
def main():
    ...
    # Use JSONFileDocumentStore instead of FirestoreDocumentStore
    docstore = JSONFileDocumentStore(persist_dir="./docstore_json") # Local JSON docstore
    ...
    for doc in documents:
        ...
        if existing_doc: # RE-ENABLED
            ...
            continue
        logger.info(f"Adding original document to docstore: {doc.doc_id}") # ADDED LOG
